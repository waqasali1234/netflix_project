<?php $__env->startSection('head_title', trans('words.movies_genres').' | '.getcong('site_name') ); ?>
 ...
 <div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li><?php echo e(trans('words.movies_genres')); ?></li>
      </ul>  
    </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-3 col-xs-6 sm-top-30">
          ...
          <div class="b-language"> 
            <a href="<?php echo e(URL::to('genres/movies/'.$genres_data->genre_slug)); ?>">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/pages/movies_genres.blade.php ENDPATH**/ ?>