          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                ...
                <p class="vfx_video_length"><i class="fa fa-clock-o"></i> <?php echo e($movies_data->duration); ?></p>
                  <h4 class="vfx_video_title"><a href="<?php echo e('show_price/'.$movies_data['id']); ?>">Price</a></h4>
               </div>
            </div>
      </div>
      </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/pages/movies.blade.php ENDPATH**/ ?>