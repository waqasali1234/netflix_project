                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12" id="right_sidebar_hide">
                                            <div class="sidebar_playlist movie_sidebar_playlist_block">
                                                <div class="caption">
                                                    <div class="left"> <a href="#"><i class="fa fa-list"></i> <?php echo e(trans('Duration Time')); ?></a> </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                               ...
                                               <h4>Plan:</h4><?php echo e($use->plan); ?>

                                                   <h4>Purchase Date:</h4>  <?php echo e($use->time); ?>

                                                    <h4>Expiry Date:</h4> <?php echo e($use->expiry_date); ?>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/pages/pad_movie.blade.php ENDPATH**/ ?>