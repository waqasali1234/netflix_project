                 ...
                 <small id="emailHelp" class="form-text text-muted">For more info <a href="https://developer.paypal.com/docs/integration/admin/manage-apps/#create-or-edit-sandbox-and-live-apps" target="_blank">click here</a></small>
                  ...
                  <br/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" name="bitcoin_payment_on_off">
                                ...
                                <option value="1" <?php if($settings->bitcoin_payment_on_off=="1"): ?> selected <?php endif; ?>>ON</option>
                                <option value="0" <?php if($settings->bitcoin_payment_on_off=="0"): ?> selected <?php endif; ?>>OFF</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="bitcoin_account_id" value="<?php echo e(isset($settings->bitcoin_account_id) ? $settings->bitcoin_account_id : null); ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="bitcoin_profile_id" value="<?php echo e(isset($settings->bitcoin_profile_id) ? $settings->bitcoin_profile_id : null); ?>" class="form-control">
                        </div>
                    </div>
                    <br/>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/admin/pages/payment_settings.blade.php ENDPATH**/ ?>