                  ...
                  <tbody>
                   <?php $__currentLoopData = $episodes_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $episodes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e(stripslashes($episodes->video_title)); ?></td>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/admin/pages/episodes_list.blade.php ENDPATH**/ ?>