                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                   <?php $__currentLoopData = $season_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $season): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e(stripslashes($season->series_name)); ?></td>
                      <td><?php echo e(stripslashes($season->season_name)); ?></td>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/admin/pages/season_list.blade.php ENDPATH**/ ?>