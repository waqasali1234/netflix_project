...
<div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li><?php echo e(trans('words.sports_text')); ?></li>
      </ul>  
    </div>
    </div>
  </div>
      ...
      <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes($sports_video->video_title),20)); ?></h4>
               </div>
            </div>
      </div>
      </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\streamit\resources\views/pages/sports.blade.php ENDPATH**/ ?>