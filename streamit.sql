...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2021 at 11:16 AM
...
CREATE TABLE `movie_videos` (
  ...
  `seo_keyword` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int(1) NOT NULL DEFAULT 1,
  `one_day_price` varchar(1232) COLLATE utf8mb4_unicode_ci NOT NULL,
  `one_month_price` varchar(1232) COLLATE utf8mb4_unicode_ci NOT NULL,
  `one_year_price` varchar(1232) COLLATE utf8mb4_unicode_ci NOT NULL,
  `life_time_price` varchar(1232) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `payments` (
  `id` int(123) NOT NULL,
  `movie_id` int(123) NOT NULL,
  `user_id` int(255) NOT NULL,
  `plan` varchar(1232) NOT NULL,
  `amount` varchar(1232) NOT NULL
...
INSERT INTO `payments` (`id`, `movie_id`, `user_id`, `plan`, `amount`) VALUES
(14, 25, 6, 'month', '35'),
(15, 21, 6, 'lifetime', '123'),
(16, 26, 6, 'day', '935'),
(17, 29, 6, 'year', '600');
...
CREATE TABLE `settings` (
  ...
  `bitcoin_payment_on_off` int(1) DEFAULT 0,
  `bitcoin_client_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bitcoin_secret` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bitcoin_account_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bitcoin_profile_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `settings` (`id`, `time_zone`, `default_language`, `styling`, `site_name`, `site_email`, `site_logo`, `site_favicon`, `site_description`, `site_keywords`, `site_header_code`, `site_footer_code`, `site_copyright`, `currency_code`, `paypal_payment_on_off`, `paypal_mode`, `paypal_client_id`, `paypal_secret`, `bitcoin_payment_on_off`, `bitcoin_client_id`, `bitcoin_secret`, `bitcoin_account_id`, `bitcoin_profile_id`, `stripe_payment_on_off`, `stripe_secret_key`, `stripe_publishable_key`, `razorpay_payment_on_off`, `razorpay_key`, `razorpay_secret`, `paystack_payment_on_off`, `paystack_secret_key`, `paystack_public_key`, `footer_fb_link`, `footer_twitter_link`, `footer_instagram_link`, `footer_google_play_link`, `footer_apple_store_link`, `smtp_host`, `smtp_port`, `smtp_email`, `smtp_password`, `smtp_encryption`, `gdpr_cookie_title`, `gdpr_cookie_text`, `gdpr_cookie_url`, `omdb_api_key`, `external_css_js`, `google_login`, `facebook_login`, `google_client_id`, `google_client_secret`, `google_redirect`, `facebook_app_id`, `facebook_client_secret`, `facebook_redirect`, `maintenance mode`, `envato_buyer_name`, `envato_purchase_code`) VALUES
(1, 'Asia/Kolkata', 'en', 'light', 'Notis Studios', 'info@viaviweb.com', 'logo_1624759474stream01.png', 'nslogo01.png', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\\\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'notisstudios.,Video Streaming,Streaming Website,Streaming App,Live TV, Movies, TV Shows', '', '', 'Copyright Â© 2019 www.notisstudios..com. All Rights Reserved.', 'USD', 1, 'sandbox', 'AS-XuMJEUYUJQcYCSZw1Uf5ch8O1NNeweXVFJONQVT47Za1wZ6GlECmyRGYuV9opNF8VAyv5Faf7zbDa', 'EPdFGUWH5kNtYscfBoBXTKFfUM8cGCeR70x7-ZLLxxGA7JhqwmCJ287JOUqNw5_2OPqQsVLDU6d8O3FB', 1, 'de8ba05825604dbaafbd1d84fd96d6b6', 'lYAGQJt5Fbo6yyC4IVblLMJaPoQpumaU9SMExiOPI1Mk', 'efab08e0-835d-45a5-af49-280f2e151c59', 'f7e2e3f3-8337-4f8b-9748-895051cb8d81', 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'https://www.facebook.com/notisstudios./', 'https://twitter.com/notisstudios./', 'https://www.instagram.com/notisstudios./', 'https://play.google.com/store/apps/dev?id=7157478532572017100', 'https://apps.apple.com/in/developer/vishal-pamar/id1141291247', '', '', '', '', 'TLS', 'This website is using cookies', 'We use them to give you the best experience. If you continue using our website, we\\\'ll assume that you are happy to receive all cookies on this website.', '#', '', 'CDN', '0', '0', NULL, NULL, 'http://localhost/laravel_video_script_update/auth/google/callback', NULL, NULL, 'http://localhost/laravel_video_script_update/auth/facebook/callback', '', 'sunny1407', '5b1f000b-9dba-48eb-bb6b-fd2730d45d87');
...
CREATE TABLE `users` (
  ...
  `cryptochil_payment_id` varchar(100) NOT NULL,
...
INSERT INTO `users` (`id`, `usertype`, `login_status`, `google_id`, `facebook_id`, `name`, `email`, `password`, `phone`, `user_address`, `user_image`, `status`, `plan_id`, `start_date`, `exp_date`, `paypal_payment_id`, `cryptochil_payment_id`, `stripe_payment_id`, `razorpay_payment_id`, `paystack_payment_id`, `plan_amount`, `confirmation_code`, `remember_token`, `session_id`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 0, NULL, NULL, 'notisstudios.', 'admin@admin.com', '$2y$10$EMeDkbAwIXJd7fAX0pWF2OZCHmKuGMwtD3ZUjg9HEOMvkaVl.5Xvm', '9227777522', NULL, 'viavi-webtech-91ba3659441552017fd53cd6ac6f9aa3-b.jpg', 1, 2, 0, 2592000, NULL, '', NULL, NULL, NULL, '0.00', NULL, 'Cdo6D23E7D4I8A72H1aoCB5aQVFOQGh0u63MUPRY2jlyzQu3BUvyqIAcfPwd', 'iXL5Efee1FhfiXQzxPTe2PzEfFqU3seM3b6TzvU7', '2020-03-12 21:16:45', '2021-09-09 18:45:31'),
(6, 'User', 0, NULL, NULL, 'Syed Subtain Haider', 'test@test.com', '$2y$10$i.Y8qcYAovJNj1CtkCxA5uTTAsstnIwemAliYxA6i3XVf0cQ20nSO', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, '', NULL, NULL, NULL, '0', NULL, NULL, NULL, '2021-09-02 08:06:17', '2021-09-02 08:06:17');
