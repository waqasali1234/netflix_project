...
//        dd('here');
        ...
        if(!empty($inputs['id'])){
         ...
         $movie_obj->one_day_price = $inputs['price_day'];
         $movie_obj->one_month_price = $inputs['price_month'];
         $movie_obj->one_year_price = $inputs['price_year'];
         $movie_obj->life_time_price = $inputs['price_life_time'];
