...
class SettingsController extends MainAdminController
{
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $settings->bitcoin_payment_on_off = $inputs['bitcoin_payment_on_off'];
//        $settings->bitcoin_client_id = $inputs['bitcoin_client_id'];
//        $settings->bitcoin_secret = $inputs['bitcoin_secret'];
        $settings->bitcoin_account_id = $inputs['bitcoin_account_id'];
        $settings->bitcoin_profile_id = $inputs['bitcoin_profile_id'];
