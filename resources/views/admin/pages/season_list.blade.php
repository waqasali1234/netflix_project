          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/season/add_season')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_season')}}"><i class="fa fa-plus"></i> {{trans('words.add_season')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                   @foreach($season_list as $i => $season)
                    <tr>
                      ...
                      <td>@if(isset($season->season_poster)) <img src="{{URL::to('upload/thumbs/'.$season->season_poster)}}" alt="image" class="thumb-lg bdr_radius"> @endif</td>
