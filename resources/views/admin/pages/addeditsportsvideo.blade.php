              ...
              <div class="card-box">
                ...
                <div class="col-md-6">
                    ...
                    <label class="col-sm-3 col-form-label">{{trans('words.video_upload_type')}}</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="video_type" id="video_type">                               
                                ...
                                <option value="HLS" @if(isset($video_info->video_type) AND $video_info->video_type=="HLS") selected @endif>HLS/m3u8</option>
                                <option value="DASH" @if(isset($video_info->video_type) AND $video_info->video_type=="DASH") selected @endif>MPEG-DASH</option>                            
                            </select>
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="subtitle_url1" id="subtitle_url1" value="{{ isset($video_info->subtitle_url1) ? $video_info->subtitle_url1 : old('subtitle_url1') }}" class="form-control" placeholder="http://example.com/demo.vtt">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="subtitle_url2" id="subtitle_url2" value="{{ isset($video_info->subtitle_url2) ? $video_info->subtitle_url2 : old('subtitle_url2') }}" class="form-control" placeholder="http://example.com/demo.vtt">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="subtitle_url3" id="subtitle_url3" value="{{ isset($video_info->subtitle_url3) ? $video_info->subtitle_url3 : old('subtitle_url3') }}" class="form-control" placeholder="http://example.com/demo.vtt">
