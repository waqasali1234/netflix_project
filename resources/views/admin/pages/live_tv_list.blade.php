          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/live_tv/add_live_tv')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.live_tv_add')}}"><i class="fa fa-plus"></i> {{trans('words.live_tv_add')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                   @foreach($live_tv_list as $i => $live_tv_data)
                    <tr>
                      ...
                      <td>@if(isset($live_tv_data->channel_thumb)) <img src="{{URL::to('upload/thumbs/'.$live_tv_data->channel_thumb)}}" alt="video image" class="thumb-lg bdr_radius"> @endif</td>
