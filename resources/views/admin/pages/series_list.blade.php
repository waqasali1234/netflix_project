          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/series/add_series')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_show')}}"><i class="fa fa-plus"></i> {{trans('words.add_show')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                   @foreach($series_list as $i => $series)
                    <tr>
                      ...
                      <td>@if(isset($series->series_poster)) <img src="{{URL::to('upload/thumbs/'.$series->series_poster)}}" alt="image" class="thumb-lg bdr_radius"> @endif</td>
