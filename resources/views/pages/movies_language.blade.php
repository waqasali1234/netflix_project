...
@section('head_title', trans('words.movies_lang').' | '.getcong('site_name') )
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-3 col-xs-6 sm-top-30">
          ...
          <div class="b-language"> 
            <a href="{{ URL::to('language/movies/'.$lang_data->language_slug) }}">
              <div class="language_text_block">
                <h3 class="name">{{stripslashes($lang_data->language_name)}}</h3>              
              </div>
