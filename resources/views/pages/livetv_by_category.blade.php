...
@section('head_title', $tv_cat_info->category_name.' '.trans('words.live_tv').' | '.getcong('site_name') )
...
<div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li>{{trans('words.popular_in')}} {{$tv_cat_info->category_name}}</li>
      </ul>  
    </div>
    </div>
  </div>
      ...
      <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title">{{Str::limit(stripslashes($live_tv_data->channel_name),20)}}</h4>
               </div>
            </div>
      </div>
      </a>
