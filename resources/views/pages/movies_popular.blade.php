...
@section('head_title', trans('words.popular_movies').' | '.getcong('site_name') )
...
<div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li>{{trans('words.popular_movies')}}</li>
      </ul>  
    </div>
    </div>
  </div>
           ...
           @foreach(explode(",",$home_sections->section3_popular_movie) as $popular_movie)            
            ...
            <div class="col-md-2 col-sm-4 col-xs-6">
              ...
              <div class="thumb-wrap"> 
                <img src="{{URL::to('upload/source/'.App\Movies::getMoviesInfo($popular_movie,'video_image_thumb'))}}" alt="Movie Thumb"> @if(App\Movies::getMoviesInfo($popular_movie,'video_access')=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif
