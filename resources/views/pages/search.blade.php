    ...
    <div class="container">
      ...
      <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title">{{Str::limit(stripslashes($sports_video->video_title),25)}}</h4>
               </div>
            </div>
      </div>
      </a>
    ...
    <div class="container">
      ...
      <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="icon fa fa-play"></i><span class="ripple"></span>
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title">{{Str::limit(stripslashes($live_tv_data->channel_name),25)}}</h4>
               </div>
            </div>
      </div>
      </a>
