...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::post('bitcoin_success', 'AdminController@bitcoin_success')->name('bitcoin_success');
...
Route::get('show_price/{id}', 'UserController@show_price');
Route::get('payment_method/{id}', 'UserController@payment_method');
Route::post('payment_save', 'UserController@payment_save');
